...
func TestParseProjectFieldValue(t *testing.T) {
	...
	cases := map[string]struct {
		...
		ProjectSchemaField   string
		ProjectSchemaValue   string
<<<<<<<< HEAD:google-beta/services/compute/temp-test/field_helpers_test.go
		Config               *Config
========
		Config               *transport_tpg.Config
>>>>>>>> e214aac40503b2e28c5bcc73b7c91726014c7e35:google-beta/tpgresource/field_helpers_test.go
	}{
		"instance is a full self link": {
